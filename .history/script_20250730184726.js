...
document.querySelectorAll('.lang-ru').forEach(el => el.classList.toggle('hidden', lang !== 'ru'));
document.querySelectorAll('.lang').forEach(el => el.classList.toggle('hidden', lang !== 'de' && lang !== 'ru'));
...
localStorage.setItem('vilana-lang', lang);
  ...
  function getSavedLanguage() {
    return localStorage.getItem('vilana-lang') || 'de';
  }
